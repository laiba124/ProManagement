                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        ...
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Task Form</h3>

                            <form action="/adminDashboard/addingTask/2" method="post" class="px-md-2">
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="text" name="title" id="form3Example1q" class="form-control" value="{{ old('tasktitle') }}" />

                                </div>
                                <div class="form-outline mb-2">
                                    <label class="form-label" for="form3Example1q">Description</label>
                                    <textarea type="textarea" name="description" value="{{ old('description') }}"id="form3Example1q" class="form-control" ></textarea></>
                                ...
                                <div class="form-outline mb-2">
                                   <br><label>Status : </label>
                                    ...
                                    <div class="form-outline mb-2">
                                        ...
                                        <select required name="project" id="tasktype">
                                            <option value="" selected disabled hidden>--Select--</option>
                                    ...
                                    <div class="form-outline mb-2">
                                        ...
                                        <select required name="type" id="tasktype">
                                            <option value="" selected disabled hidden>--Select--</option>
                                ...
                                <a href="/adminDashboard/tasks" id="btn" class="btn btn-primary mb-1">Back</a></td>
